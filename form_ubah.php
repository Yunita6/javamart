<div class="d-flex flex-column flex-md-row px-4 py-2 mt-4 text-white bg-indigo rounded shadow">
  ...
  <div class="ms-5 ms-md-0 pt-md-3 pb-md-0">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="http://www.javamart.com/"><i class="fas fa-home"></i></a></li>
      ...
      <div class="col-md-7">
        ...
        <div class="mb-3 pt-2">
          ...
          <select name="jenis_member" class="form-select" autocomplete="off" required>
            ...
            <option value="Member Biru">Member Biru</option>
            <option value="Member Platinum">Member Platinum</option>
